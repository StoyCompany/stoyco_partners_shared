...
AnnouncementsContentModel _$AnnouncementsContentModelFromJson(
  ...
  approvedVideos: (json['approvedVideos'] as num).toInt(),
  contentPerUser: (json['contentPerUser'] as num).toInt(),
...
Map<String, dynamic> _$AnnouncementsContentModelToJson(
  ...
  'approvedVideos': instance.approvedVideos,
  'contentPerUser': instance.contentPerUser,
